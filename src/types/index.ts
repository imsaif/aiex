 ...
 */
export type GuideTool = 'Claude Code' | 'Claude Design' | 'Claude Docs' | 'Claude Slides' | 'Cursor' | 'GitHub' | 'GitHub Copilot' | 'Replit AI' | 'V0 by Vercel' | 'Figma' | 'Conversational UI' | 'Other';
