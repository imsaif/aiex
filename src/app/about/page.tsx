            ...
            <div className="mb-16">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 border border-accent-primary bg-white text-accent-primary rounded-full font-medium hover:bg-gray-50 hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
                  Contribute
                </a>
              </div>
