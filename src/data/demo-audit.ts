  ...
  topGaps: [
    {
      ...
      impact: 'Users cannot tell which answers to trust, so they either over-rely on a wrong answer or abandon the tool after one bad experience.',
    ...
    },
    {
      ...
      impact: 'When the AI gets stuck or answers wrongly, users have no escape hatch and are likely to churn instead of getting the task done.',
      effort: 'medium' as const,
    ...
    },
    {
      ...
      impact: 'A dead-end error with no retry nudges users to abandon the task rather than try again.',
    ...
    },
    {
      ...
      impact: 'Without sources or reasoning, users cannot verify answers, which caps trust for anything high-stakes.',
      effort: 'medium' as const,
    ...
    },
    {
      ...
      impact: 'Users cannot control what the AI retains, which erodes trust and raises privacy concerns over repeat sessions.',
