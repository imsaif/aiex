...
export const codeExamples: CodeExample[] = [
  {
    title: "Privacy-First AI Settings Panel",
    description: "This React component demonstrates privacy-first design with granular controls, clear data usage explanations, and transparent privacy trade-offs for AI features.",
    language: "tsx",
    componentId: "privacy-first-design-demo",
    code: `'use client';
