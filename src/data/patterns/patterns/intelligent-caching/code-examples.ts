...
export const codeExamples: CodeExample[] = [
  {
    title: "Smart AI Response Cache",
    description: "This React component demonstrates intelligent caching of AI responses with automatic freshness detection, cache warming, and predictive pre-fetching based on user patterns.",
    language: "tsx",
    componentId: "intelligent-caching-demo",
    code: `'use client';
