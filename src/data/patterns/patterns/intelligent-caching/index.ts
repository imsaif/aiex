...
export const intelligentcaching: Pattern = {
  ...
  content: {
    skillDescription:
      "Use when AI responses feel slow or repeated queries recompute: latency complaints, 'answers take too long', pre-fetching likely requests, caching common results. Intelligent Caching makes frequent AI results instant.",
