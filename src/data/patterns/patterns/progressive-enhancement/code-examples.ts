...
export const codeExamples: CodeExample[] = [
  {
    title: "Progressive AI Response Generator",
    description: "This React component demonstrates progressive enhancement by showing an immediate basic response, then streaming additional detail and sophistication as the AI continues processing.",
    language: "tsx",
    componentId: "progressive-enhancement-demo",
    code: `'use client';
