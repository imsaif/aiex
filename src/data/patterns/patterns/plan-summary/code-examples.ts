...
export const codeExamples: CodeExample[] = [
  {
    title: "Research Task Plan Summary",
    description: "An interactive plan summary showing goal interpretation, strategy, a progress checklist, and editable assumptions for a research task.",
    language: "tsx",
    componentId: "plan-summary-demo",
    code: `'use client';
