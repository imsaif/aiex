...
export const codeExamples: CodeExample[] = [
  {
    title: "Trust Calibration Dashboard",
    description: "An interactive trust dashboard showing per-domain accuracy, milestone badges, and autonomy upgrade prompts based on agent performance history.",
    language: "tsx",
    componentId: "trust-calibration-demo",
    code: `'use client';
