  ...
  return (
    <div>
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 px-8 py-4 bg-accent-primary text-white rounded-full text-lg font-semibold hover:bg-accent-hover transition-all active:scale-95 shadow-[0_4px_20px_rgba(22,32,54,0.35)] hover:shadow-[0_6px_28px_rgba(22,32,54,0.5)]"
      >
