    ...
    <div className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          See how AI makes decisions with transparent reasoning and confidence scores
        </p>
      </div>
            ...
            <AnimatePresence>
              {showDetails && (
                ...
                >
                  ...
                  {/* Reasoning Steps */}
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-800 mb-3">Reasoning Process:</h5>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-800 mb-3">Alternative Predictions:</h5>
                    <div className="space-y-2">
