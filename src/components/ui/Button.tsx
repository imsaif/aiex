...
export default function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-surface-secondary text-text-primary hover:bg-background-tertiary focus:ring-border-focus border border-border-primary',
    outline: 'border border-border-primary bg-surface-primary text-text-primary hover:bg-accent-subtle focus:ring-border-focus',
